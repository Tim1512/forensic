...
Description: 
    Script to carve and search for data in large repositories of log event log files where standard review may be tedious. Usecase is to search for item like username, domain or IP Address to determine existance and get a copy of record.
    The script will spit out the record containing each search hit to an output file configured in run command.
...
Instructions:
    ...
    $ python bulk_evtx_searcher.py -h
'''
